package ec.udemy.javase11.developer.primitive_types_string.primitive_data_type;/*
...
public class FooBar {
    public static void main(String[] args) {
        ...
        while (true) { // we Knows that it is  executed at least once
            u = v++;
            break;
        }
    ...
    /*
    * Conclusión: Como no hay una garantía estática de que el bloque del while se ejecute, el compilador reporta
    * un error y exige que u sea inicializada antes de usarla.
    * */
